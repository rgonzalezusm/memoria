...
public final class RSFrontUtils {
    ...
    public static void showWarn(String msg) {
        Notification notification = Notification.show(msg, 1500, Notification.Position.MIDDLE);
        notification.addThemeVariants(NotificationVariant.LUMO_CONTRAST);
    }

    public static void showError(String msg) {
        Notification notification = Notification.show(msg, 1800, Notification.Position.MIDDLE);
