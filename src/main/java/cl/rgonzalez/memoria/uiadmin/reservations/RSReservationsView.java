package cl.rgonzalez.memoria.uiadmin.reservations;
...
@PageTitle("Reservas")
@Route(value = "admin/reservas", layout = RSMainLayoutAdmin.class)
@RolesAllowed("ADMIN")
...
//    }
    ...
    private Component createGrid() {
        ...
        grid.addColumn(r -> r.getName()).setHeader("Usuario").setWidth("220px");
        grid.addColumn(r -> r.getCourse()).setHeader("Ramo").setWidth("120px");
        grid.addColumn(r -> r.getParallel()).setHeader("Paralelo").setWidth("120px");
