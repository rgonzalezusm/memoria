package cl.rgonzalez.memoria.ui.components.appnav;
...
/**
 * A menu item for the {@link RSAppNav} component.
 * <p>
 * Can contain a label and/or an icon and links to a given {@code path}.
 */
@JsModule("@vaadin-component-factory/vcf-nav")
@Tag("vcf-nav-item")
public class RSAppNavItem extends Component {
     ...
     */
    public RSAppNavItem(String label) {
        setLabel(label);
    }
     ...
     *            the path to link to
     */
    public RSAppNavItem(String label, String path) {
        setPath(path);
        setLabel(label);
    }
     ...
     *            the view to link to
     */
    public RSAppNavItem(String label, Class<? extends Component> view) {
        setPath(view);
        setLabel(label);
    }
     ...
     */
    public RSAppNavItem(String label, String path, Component icon) {
        setPath(path);
        setLabel(label);
        setIcon(icon);
    }
     ...
     *            the icon for the item
     */
    public RSAppNavItem(String label, Class<? extends Component> view, Component icon) {
        setPath(view);
        setLabel(label);
        setIcon(icon);
    }
     ...
     */
    public RSAppNavItem addItem(RSAppNavItem... appNavItems) {
        for (RSAppNavItem appNavItem : appNavItems) {
     ...
     * @return this item for chaining
     */
    public RSAppNavItem removeItem(RSAppNavItem appNavItem) {
     ...
     * @return this item for chaining
     */
    public RSAppNavItem removeAllItems() {
     ...
     */
    public RSAppNavItem setLabel(String label) {
     ...
     * @return this instance for chaining
     */
    public RSAppNavItem setPath(String path) {
     ...
     * @return this instance for chaining
     */
    public RSAppNavItem setPath(Class<? extends Component> view) {
     ...
     * @return this instance for chaining
     */
    public RSAppNavItem setIcon(Component icon) {
     ...
     */
    public RSAppNavItem setExpanded(boolean value) {
        if (value) {
