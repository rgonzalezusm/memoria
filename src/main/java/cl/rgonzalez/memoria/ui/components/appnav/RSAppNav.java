 ...
 * <p>
 * Items can be added using {@link #addItem(RSAppNavItem)} and hierarchy can be
 * created by adding {@link RSAppNavItem} instances to other {@link RSAppNavItem}
 * instances.
 */
@JsModule("@vaadin-component-factory/vcf-nav")
@Tag("vcf-nav")
@NpmPackage(value = "@vaadin-component-factory/vcf-nav", version = "1.0.6")
public class RSAppNav extends Component implements HasSize, HasStyle {
     ...
     */
    public RSAppNav addItem(RSAppNavItem... appNavItems) {
     ...
     * @return the menu for chaining
     */
    public RSAppNav removeItem(RSAppNavItem appNavItem) {
     ...
     */
    public RSAppNav removeAllItems() {
     ...
     */
    public RSAppNav setLabel(String label) {
     ...
     * @return this instance for chaining
     */
    public RSAppNav setCollapsible(boolean collapsible) {
