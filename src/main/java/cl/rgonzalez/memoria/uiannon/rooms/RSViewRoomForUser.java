package cl.rgonzalez.memoria.uiannon.rooms;
...
@PageTitle("Salas")
@Route(value = "salas", layout = RSMainLayoutAnnon.class)
@AnonymousAllowed
public class RSViewRoomForUser extends VerticalLayout {
...
//    private Button buttonDelete = new Button("Eliminar");
    ...
    public RSViewRoomForUser(RSSrvRoom srvRoom) {
